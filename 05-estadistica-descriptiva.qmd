...
## 🎓 Avanzado: Regla de Sturges para bins
...
::: {.callout-note .callout-avanzado collapse="true"}
## 🎓 Avanzado: ¿Por qué n-1? (Corrección de Bessel) La corrección de Bessel ajusta por usar la media muestral en lugar de la media poblacional. Esto hace que la varianza muestral sea un estimador insesgado de la varianza poblacional.
:::
...
::: {.callout-note .callout-avanzado collapse="true"}
## 🎓 Avanzado: Coeficiente de variación
...
La estadística descriptiva resume y caracteriza datos antes del análisis inferencial. Las medidas de tendencia central (media, mediana, moda) indican valores típicos; las de dispersión (varianza, desviación estándar, IQR) cuantifican cuánto varían los datos alrededor de esos valores.

La elección de estadísticos depende de la distribución: para datos simétricos, media y desviación estándar; para datos asimétricos o con outliers, mediana e IQR. Siempre visualiza tus datos antes de resumirlos numéricamente.
