...
::: {.ejemplo}
**Caso: Diferencia salarial por género**

Comparamos ingresos promedio entre hombres y mujeres en Chile.
...
Para datos pareados (mismo sujeto medido dos veces, o pares emparejados).

::: {.ejemplo}
**Caso: Antes y después de intervención**
...
::: {.ejemplo}
**Caso: Ingresos por nivel educacional**
...
- Agresti, A. & Finlay, B. (2009). *Statistical Methods for the Social Sciences*. Capítulo 7: Comparison of Two Groups.
- Llaudet, E. & Imai, K. (2022). *Data Analysis for Social Science*. Capítulo 3: Causality.
